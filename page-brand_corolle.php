...
<img class="Lordly_Brands_ArticleImg" src="<?php echo LDY_ITR; ?>skin/image/brands/article/corolle.png" />

<?php include('includes/BrandsMenu.inc.php'); ?>

<?php while ( have_posts() ) : the_post(); ?>
        <h4><?php the_title(); ?></h4>
        <p>官方网站：<a href="http://www.corolle.com" title="COROLLE" target="_blank" class="Lordly_outsite_link">http://www.corolle.com</a></p>
        <p>代理产品：<a href="http://www.clayeux.com" title="COROLLE" target="_blank" class="Lordly_outsite_link">香水</a></p>
