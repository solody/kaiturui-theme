...
<img class="Lordly_Brands_ArticleImg" src="<?php echo LDY_ITR; ?>skin/image/brands/article/bvlgari.png" />

<?php include('includes/BrandsMenu.inc.php'); ?>

<?php while ( have_posts() ) : the_post(); ?>
        <h4><?php the_title(); ?></h4>
        <p>官方网站：<a href="http://www.bulgari.com/" title="BVLGARI 宝格丽" target="_blank" class="Lordly_outsite_link">http://www.bulgari.com/</a></p>
        <p>代理产品：<a href="http://zh-cn.bulgari.com/department.jsp?cat=cat00006" title="BVLGARI 宝格丽" target="_blank" class="Lordly_outsite_link">香水</a></p>
